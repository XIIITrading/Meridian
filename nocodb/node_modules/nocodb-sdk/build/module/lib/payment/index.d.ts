...
export declare const PlanMeta: {
    ...
    readonly Business: {
        ...
        readonly color: "#FAF5FF";
        readonly accent: "#FEB0E8";
        readonly primary: "#972377";
        readonly bgLight: "#FFEEFB";
        readonly bgDark: "#FED8F4";
        readonly border: "#FEB0E8";
        readonly chartFillColor: "#972377";
    };
    readonly Enterprise: {
...
export declare const LOYALTY_GRACE_PERIOD_END_DATE = "2025-07-31";
