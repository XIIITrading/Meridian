...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
     ...
     */
        getViewRowColor: (viewId: IdType, params?: RequestParams) => Promise<void>;
        /**
     ...
     */
        deleteViewRowColor: (viewId: IdType, params?: RequestParams) => Promise<void>;
        /**
         * No description
         *
         * @tags DB View
         ...
         * @response `200` `void` OK
         */
        viewRowColorSelectAdd: (viewId: IdType, data: {
         ...
         * @response `200` `void` OK
         */
        viewRowColorConditionAdd: (viewId: IdType, data: {
            ...
            filter: {
                /** Comparison operator */
                comparison_op: "eq" | "neq" | "gt" | "gte" | "lt" | "lte" | "like" | "nlike" | "in" | "nin" | "is" | "isnot" | "null" | "notnull";
         ...
         * @response `200` `void` OK
         */
        viewRowColorConditionUpdate: (viewId: IdType, id: IdType, data: {
            /** Color to apply to matching rows */
            color: string;
            /** Whether to use the color as background */
            is_set_as_background: boolean;
         ...
         * @response `200` `void` OK
         */
        viewRowColorConditionDelete: (viewId: IdType, id: IdType, params?: RequestParams) => Promise<void>;
        /**
     ...
     */
        samplePayloadGet: (tableId: IdType, operation: "insert" | "update" | "delete" | "bulkInsert" | "bulkUpdate" | "bulkDelete", version: "v1" | "v2" | "v3", params?: RequestParams) => Promise<{
            /** Sample Payload Data */
            data?: object;
        }>;
        /**
